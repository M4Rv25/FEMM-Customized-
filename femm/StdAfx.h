...
#define BuildMask	4
	...
	#define dColor19 RGB(19,13,37)
	#define dColor18 RGB(36,20,50)
	#define dColor17 RGB(53,25,62)
	#define dColor16 RGB(72,28,72)
	#define dColor15 RGB(91,30,81)
	#define dColor14 RGB(112,31,87)
	#define dColor13 RGB(132,30,90)
	#define dColor12 RGB(152,27,91)
	#define dColor11 RGB(173,23,89)
	#define dColor10 RGB(193,23,84)
	#define dColor09 RGB(211,33,75)
	#define dColor08 RGB(225,51,66)
	#define dColor07 RGB(235,72,62)
	#define dColor06 RGB(240,96,67)
	#define dColor05 RGB(243,118,81)
	#define dColor04 RGB(245,141,100)
	#define dColor03 RGB(246,161,120)
	#define dColor02 RGB(246,180,143)
	#define dColor01 RGB(247,199,168)
	#define dColor00 RGB(248,217,195)

	// Other colors
	#define dSelColor       RGB(255,0,0)
	#define dMeshColor      RGB(213,228,20)
	#define dBlockColor     RGB(0,125,0)
	#define dLineColor      RGB(0,0,0)
	#define dRegionColor    RGB(0,255,0)
	#define dGridColor    	RGB(0,0,0)
	#define dBackColor      RGB(255,255,255)
	#define dNodeColor	  	RGB(0,0,0)
	#define dTextColor      RGB(0,0,0)
	#define dRealFluxLineColor   RGB(200,200,200)
	#define dImagFluxLineColor   RGB(128,128,128)
	#define dNameColor	 	RGB(0,0,0)
	#define dMaskLineColor   RGB(255,128,64)
	#define dRealVectorColor   RGB(200,200,200)
